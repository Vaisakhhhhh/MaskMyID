    ...
    return (
        <div className="flex flex-col h-full w-full">
            <header className="flex items-center justify-between px-6 py-4 border-b border-zinc-800 bg-zinc-900/50 backdrop-blur-md">
                <div className="flex flex-col cursor-pointer hover:opacity-80 transition" onClick={() => setPage('landing')}>
                ...
                <div className="flex items-center gap-3">
                    <button onClick={() => setPage('landing')}
                        className="flex items-center gap-2 px-4 py-2 text-sm font-medium transition rounded-lg text-zinc-300 hover:text-white hover:bg-zinc-800 border border-zinc-700">
                        Back to Home
                    </button>
                </div>
            </header>
